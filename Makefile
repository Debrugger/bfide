...
# for clang
#COMPILER := clang++
#FLAGS    := -g -Wall -fdiagnostics-color=never -fno-show-source-location -std=c++11 -DARCH=\"$(shell uname -m)\" -fPIC
...
# examples:
# MOC: src/include/lobby.h -> build/lobby.moc.cpp
# UI:  src/ui/lobby.ui     -> build/lobby.ui.h
